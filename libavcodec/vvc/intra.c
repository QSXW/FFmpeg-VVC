...
{
    const CodingUnit *cu = lc->cu;
    static const enum TxType mts_to_trh[] = { VVC_DCT2, VVC_DST7, VVC_DCT8, VVC_DST7, VVC_DCT8 };
    static const enum TxType mts_to_trv[] = { VVC_DCT2, VVC_DST7, VVC_DST7, VVC_DCT8, VVC_DCT8 };
    const VVCSPS *sps       = fc->ps.sps;
